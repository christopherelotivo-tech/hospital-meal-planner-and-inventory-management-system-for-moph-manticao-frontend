  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="md:hidden">
      ...
      <div class="bg-purple-600 text-white p-4 flex items-center justify-between">
        ...
        <h1 class="brand-font text-lg font-bold">Dietitian Portal</h1>
          ...
          <div class="w-64 h-full bg-white shadow-xl" @click.stop>
            <div class="bg-purple-600 text-white p-6">
              <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p class="text-xs text-purple-200">Dietitian</p>
                </div>
              </div>
            </div>
            ...
            <nav class="p-4">
              <button
                ...
                :class="currentModule === item.id ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-gray-100'"
              >
      ...
      >
        ...
        <div class="p-6 flex items-center space-x-3 border-b border-gray-50 whitespace-nowrap overflow-hidden">
          ...
          <div class="transition-opacity duration-300" :class="{'opacity-0 w-0 hidden': !desktopSidebarOpen}">
            <h2 class="text-green-600 text-sm font-bold leading-tight">MOPH - Manticao</h2>
            <p class="text-xs text-gray-500 font-medium">Dietitian Portal</p>
          </div>
        </div>
            ...
            <div class="relative profile-dropdown-container">
              <button @click="profileMenuOpen = !profileMenuOpen" class="flex items-center space-x-4 focus:outline-none hover:bg-gray-55 p-1.5 rounded-lg transition-colors">
                <div class="text-right hidden sm:block">
                  <p class="text-sm font-bold text-gray-800 leading-tight">{{ authStore.currentUser?.name || 'Dietitian Officer' }}</p>
                  <p class="text-xs text-gray-500">Dietitian</p>
                </div>
